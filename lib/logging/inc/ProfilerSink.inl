...
namespace HeaderTech::Logging {
    ...
    ProfilerSink<Mutex>::ProfilerSink()
            : spdlog::sinks::base_sink<Mutex>(), m_profiler(HeaderTech::Profiler::ProfilerManager::Get())
    {
    ...
    ProfilerSink<Mutex>::ProfilerSink(std::unique_ptr<spdlog::formatter> formatter)
            : spdlog::sinks::base_sink<Mutex>(formatter), m_profiler(HeaderTech::Profiler::ProfilerManager::Get())
    {
